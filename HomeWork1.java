...
/*1) Flower bed is shaped like a circle. Calculate the perimeter and area by entering the radius. Output obtained results*/
				System.out.println("What is the radius of the flower bed?");
				double fb_radius = Double.parseDouble(br.readLine());
				
				System.out.println("The perimeter of the flower bed is " + (2*Math.PI*fb_radius));
				System.out.println("The area of the flower bed is " + (Math.PI*Math.pow(fb_radius,2)));

				
/*2) Define string variable name and integer value age. Output question "What is your name?"
